...
@router.post("/api/create_venue", response_model=_schemas.Venue)
...
@router.post("/api/create_event_venue/{event_id}", response_model=_schemas.Venue)
...
# get venue by id
@router.get("/api/venues/{venue_id}", response_model=_schemas.Venue)
...
# get all venues
@router.get("/api/venues", response_model=list[_schemas.Venue])
...
# get user venues
@router.get("/api/user_venues", response_model=list[_schemas.Venue])
